 ...
 */
class Invoice extends \Alltobill\Models\Base
{
     ...
     * can be found here: http://developers.alltobill.com/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the Alltobill site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.alltobill.com/docs/miscellaneous
     *
    ...
    {
        return new \Alltobill\Models\Response\Invoice();
    }
}
